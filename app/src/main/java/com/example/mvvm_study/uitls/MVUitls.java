 ...
 * @Author: gxy
 * @Time: 2022/10/31 21:59
 * @Description: 描述
 */
public class MVUitls {

    private static MVUitls mInstance;
    ...
    public static MVUitls getInstance() {
        // 双检锁
        if(mInstance == null) {
            synchronized (MVUitls.class){
                if(mInstance == null) {
                    mInstance = new MVUitls();
                }
            }
        }
        return mInstance;
